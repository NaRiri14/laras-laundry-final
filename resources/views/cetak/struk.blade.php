...
<head>
    ...
    <style>
        ...
        body { font-family: 'Courier New', monospace; width: 100%; margin: 0; padding: 3mm; font-size: 10px; color: black; background: white; box-sizing: border-box; }
        .text-center { text-align: center; }
        .line { border-bottom: 1px dashed #000; margin: 4px 0; }
        .bold { font-weight: bold; }
        .row { display: flex; justify-content: space-between; }
        .area-tombol { text-align: center; margin-bottom: 20px; }
        .btn-kembali { display: inline-block; padding: 10px 20px; background: #00d4aa; color: white; text-decoration: none; border-radius: 8px; font-family: 'Segoe UI', sans-serif; font-weight: bold; font-size: 14px; }
